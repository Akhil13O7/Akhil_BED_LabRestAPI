...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	import="java.util.List, com.gl.studentmanagement.entity.Student"%>
<html>
<head>
<style>
.myDivhead {
	...
	<div>
		...
		<table>
			...
			for (Student student : studList) {
				...
				+ "</td><td><a href='/Student_debate/student/showFormUpdate?studId=" + student.getStudId()
				+ "'>Update</a> | " + "<a href='/Student_debate/student/delete?studId=" + student.getStudId()
